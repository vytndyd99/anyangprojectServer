...
import com.anyangProject.anyangNoticeBoardProject.security.UserRole;
...
public class UserSecurityService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username)
        ...
        if(userEntity.isEmpty()) {
            throw new UsernameNotFoundException("사용자를 찾을 수 " +
                    "없습니다.");
        }
        ...
        return new User(userEntity1.getUsername(),  userEntity1.getPassword(),
                authorities);
    }
}
