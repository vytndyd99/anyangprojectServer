...
import com.anyangProject.anyangNoticeBoardProject.form.AnswerForm;
import com.anyangProject.anyangNoticeBoardProject.service.AnswerService;
...
public class AnswerController {
    ...
    , Principal principal) {
        ...
        UserEntity userEntity = this.userService.getUser(principal
                .getName());
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping("/vote/{id}")
    public String answerVote(Principal principal, @PathVariable("id")
                             Integer id) {
        Answer answer = this.answerService.getAnswer(id);
